...
schema_orders = [
        ...
        bigquery.SchemaField("totalReceivedSet", bigquery.enums.SqlTypeNames.FLOAT64),
        bigquery.SchemaField("totalRefundedSet", bigquery.enums.SqlTypeNames.FLOAT64),
        bigquery.SchemaField("totalRefundedShippingSet", bigquery.enums.SqlTypeNames.FLOAT64),
        bigquery.SchemaField("totalShippingPriceSet", bigquery.enums.SqlTypeNames.FLOAT64),
        bigquery.SchemaField("totalTaxSet", bigquery.enums.SqlTypeNames.FLOAT64),    
        ...
        bigquery.SchemaField("shippingDiscount", bigquery.enums.SqlTypeNames.FLOAT64),
        bigquery.SchemaField("shippingAfterDiscount", bigquery.enums.SqlTypeNames.FLOAT64),
        bigquery.SchemaField("originalShippingPrice", bigquery.enums.SqlTypeNames.FLOAT64),
