...
bulk_query_response = utils.bulk_query_request(p_queries.backfill_products,SHOPIFY_ACCESS_TOKEN)
...
gcloud.bigquery_write_table_truncate(client, line_items_processed_df, table_id,'product')